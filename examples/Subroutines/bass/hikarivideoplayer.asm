...
arch snes.cpu
output "BASSvideoplayer.sfc", create
...
//May need to change
//Variables (7e as I am using FastROM)
//Lorom makes it no actually matter
constant dispcnt($0000)


constant stddur($0001)
constant altdur($0002)
constant altcnt($0003)
constant curdur($0004)
constant curcnt($0005)
constant numframes($0006)
constant numframes2($0007)
constant firstframe($0008)
constant charptr($0009)

constant dma_a_bank($000A)
constant dma_a_addr($000B)
constant dma_b_reg($000D)
constant dma_len($000E)
constant dma_mode($0010)

constant isr_flag($0011)
...
origin 0
	...
	//SNES_INIT(FASTROM)
	jsr snes_init
	//This is required if you want to hear things
	jsr spc_upload
	lda #$01
	sta $420d //fast cpu
